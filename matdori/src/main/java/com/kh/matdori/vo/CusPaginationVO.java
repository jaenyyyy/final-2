...
public class CusPaginationVO {
	...
	private int size = 5; //보여줄 게시판의 글 수 
	private int count; //전체 글 수 
	private int navigatorSize = 10; //하단 네비게이터 표시 개수(기본 : 10)

	private String rezCustomerId;//찜내역 용
	
	public String getRezCustomerId() {
        return rezCustomerId;
    }

    public void setRezCustomerId(String rezCustomerId) {
        this.rezCustomerId = rezCustomerId;
    }
