...
<form action="join" action="join" method="post" autocomplete="off">
	<div class="container form-border mt-30">
		...
		<div class="row left">
			...
			<br>
		<div class="row left">
			이메일 : <input type="text" name="customerEmail" placeholder="matdori01@kh.com">
			<div class="fail-feedback"> 이메일 형식이 올바르지 않습니다.</div>
			<div class="fail2-feedback"> 가입 된 이메일이 존재합니다. </div>
			</div>
