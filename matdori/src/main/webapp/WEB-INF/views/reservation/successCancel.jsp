	...
	<div class="col-md-8 mx-auto">
		...
		<div class="row justify-content-center mb-4" style="margin-top:80px;">
			<div class="col mt-4">
				<h1 class="text-center ">
					<i class="fa-solid fa-check" style="color: #ffb416;"></i> 예약이 취소 되었습니다.
				</h1>
			</div>
		</div>
		...
		<div class="row mt-4" style="margin-bottom:100px;">
			<div class="col">
				...
				<a href="${pageContext.request.contextPath}/reservation/payment/list?rezNo=${rezNo}" class="btn btn-warning">예약상세</a>
