	...
	<div class="col">
		...
		<div class="row justify-content-center mb-3"style="margin-top: 70px;">
			<div class="col-6">
				...
				<!-- 별점 -->
				<div class="row">
					<i class="fa-solid fa-star fa-2x" style="color: #ff2424;"> 
					<span class="star-avg">별점평균추가</span>
					</i>
				</div>
			</div>
		...
		<!-- 메뉴버튼 : 네비바로 사용함 -->
		<nav class="container-fluid navbar navbar-expand-lg bg-light mb-4" data-bs-theme="light" id="navbar">
		        <div class="collapse navbar-collapse" id="navbarColor01">
		            <ul class="navbar-nav w-100">
		                <li class="nav-item flex-fill text-center">
		                    <a class="nav-link fw-bold" href="#homeSection">홈</a>
		                </li>
		                <li class="nav-item flex-fill text-center">
		                    <a class="nav-link fw-bold" href="#noticeSection">공지</a>
		                </li>
		                <li class="nav-item flex-fill text-center">
		                    <a class="nav-link fw-bold" href="#menuSection">메뉴</a>
		                </li>
		                <li class="nav-item flex-fill text-center">
		                    <a class="nav-link fw-bold" href="#reviewSection">리뷰</a>
		                </li>
		            </ul>
		        </div>
		</nav>
		...
		<!-- 상세정보 -->
		<div class="row justify-content-center text-center list-border info-margin">
			<!-- 제목 -->
			...
			<div class="col-6 text-start">
				<div class="row">
					매장위치 :  ${resDto.resAddr1} ${resDto.resAddr2}
				</div>
				<div class="row">
					영업 시간 : ${resDto.resOpenTime}
				</div>
				<div class="row">
					매장번호 : ${resDto.resTel}
				</div>
			...
			<div class="row justify-content-center mt-4 text-center">
				<div class="col">
					<h4><span class="badge rounded-pill bg-light text-black">#루프탑</span></h4>
				</div>
				<div class="col">
					<h4><span class="badge rounded-pill bg-light text-black">#혼술</span></h4>
				</div>
				<div class="col">
					<h4><span class="badge rounded-pill bg-light text-black">#주차</span></h4>
				</div>
				<div class="col">
					<h4><span class="badge rounded-pill bg-light text-black">#노키즈존</span></h4>
				</div>
				<div class="col">
					<h4><span class="badge rounded-pill bg-light text-black">#흡연실</span></h4>
				</div>
			</div>
		...
		<!-- 공지사항 -->
		<div class="row justify-content-center text-center list-border info-margin " id="noticeSection">
			<!-- 제목 -->
			<div class="row text-start">
				<h3>
		...
		<!-- 메뉴 -->
		<div class="row justify-content-center text-center list-border info-margin" id="menuSection">
			<!-- 제목 -->
			<div class="row text-start">
				<h3>
			...
			<!-- 상세로 가는 a태그 -->
			<div class="row mt-4">
				<h5><a href="" class="under-line text-badge">
					메뉴 더보기<i class="fa-solid fa-angles-right" style="color: #000000;"></i>
				</a></h5>
			</div>
		</div>
		...
		<div class="row justify-content-center text-center list-border info-margin" id="reviewSection">
			...
			<div class="row mt-4">
				<h5><a href="" class="under-line text-badge">
					리뷰 더보기<i class="fa-solid fa-angles-right" style="color: #000000;"></i>
				</a></h5>
			</div>
		</div>
