...
<div class="container" id="fullPageContent">
    <div class="row justify-content-center text-center list-border info-margin" id="reviewSection">
        ...
        <c:forEach var="entry" items="${menuListByType}">
            <div class="menu-type">
                <h4><${entry.key.menuTypeName}><hr></h4> <!-- 메뉴 타입 이름 -->
                <div class="row">
                    <c:forEach var="menu" items="${entry.value}"> <!-- 메뉴 리스트 -->
                        <div class="col-md-4">
                            <div class="menu-item">
                                <img class="card-img-top" src="/image/menu/${menu.menuNo}" alt="${menu.menuName}">
                                <h5>${menu.menuName}</h5>
